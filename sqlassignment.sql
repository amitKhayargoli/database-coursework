...
-- Inserting addresses from Teachers table
...
-- Insert data into the Teachers table with address_id
...
insert into attendance
values(7, 103, '2023-07-04', 'Absent'),
(8, 103, '2023-07-24', 'Present');
...
insert into Address
Values(9,"Kathmandu",3,"Bhaktapur","Bagmati");

insert into Guardians
Values(4,"Aman Khayargoli","9844001980");

insert into Students
Values(104,"Amit Khayargoli","2004-09-23","Male",4,9);
select * from Students;
select * from Guardians;
select * from Address;
...
-- To get the overall percentage of each student
SELECT 
    r.Student_id,
    s.StudentName,
    SUM(r.Score) AS TotalMarks,
...
-- Update the grades by deducting 10%
UPDATE Results
...
-- Step 1: Insert manual Absent records for 10 consecutive days
...
-- Step 2.1: Create a temporary table to hold the results of students with 10 consecutive absences
...
-- Step 2.2: Delete the records from the Attendance table using the temporary table
DELETE a
FROM Attendance a
